...
- (void)handleResponseWithNSString:(NSString *)response {
  ...
  ComRemulasceLametroappJava_coreLaMetroUtil_fillinAgencyAndStopIDWithJavaUtilList_withComRemulasceLametroappJava_coreBasic_typesAgency_withNSString_(arrivals, [((ComRemulasceLametroappJava_coreBasic_typesStop *) nil_chk(stop_)) getAgency], [stop_ getStopID]);
  if (arrivals == nil) {
  ...
  for (ComRemulasceLametroappJava_coreDynamic_dataTypesArrival * __strong newA in nil_chk(arrivals)) {
    ...
    if ([self arrivalTrackedWithComRemulasceLametroappJava_coreDynamic_dataTypesArrival:newA]) {
      ...
      @synchronized(trackedArrivals_) {
        for (ComRemulasceLametroappJava_coreDynamic_dataTypesStopRouteDestinationArrival * __strong arrival in nil_chk(trackedArrivals_)) {
          if ([((ComRemulasceLametroappJava_coreBasic_typesDestination *) nil_chk([((ComRemulasceLametroappJava_coreDynamic_dataTypesStopRouteDestinationArrival *) nil_chk(arrival)) getDirection])) isEqual:[newA getDirection]] && [((ComRemulasceLametroappJava_coreBasic_typesRoute *) nil_chk([arrival getRoute])) isEqual:[newA getRoute]] && [stop_ isEqual:[newA getStop]]) {
            a = arrival;
            break;
          }
        }
