...
- (jboolean)stopBasicallyMatchesWithComRemulasceLametroappJava_coreBasic_typesStop:(ComRemulasceLametroappJava_coreBasic_typesStop *)a
  ...
  return ([((ComRemulasceLametroappJava_coreBasic_typesAgency *) nil_chk([((ComRemulasceLametroappJava_coreBasic_typesStop *) nil_chk(a)) getAgency])) isEqual:[((ComRemulasceLametroappJava_coreBasic_typesStop *) nil_chk(b)) getAgency]] && [((NSString *) nil_chk([a getStopID])) isEqual:[b getStopID]]);
}
...
- (void)updateArrivalTimesWithJavaUtilCollection:(id<JavaUtilCollection>)updatedArrivals {
  ...
  if (arrivals_ != nil && [arrivals_ size] > 0 && [((id<JavaUtilIterator>) nil_chk([arrivals_ iterator])) hasNext]) {
    if ([((ComRemulasceLametroappJava_coreDynamic_dataTypesArrival *) nil_chk([((id<JavaUtilIterator>) nil_chk([arrivals_ iterator])) next])) getVehicleNum] == nil) {
      [arrivals_ clear];
    }
  }
  for (ComRemulasceLametroappJava_coreDynamic_dataTypesArrival * __strong update in updatedArrivals) {
    if ([((ComRemulasceLametroappJava_coreBasic_typesDestination *) nil_chk([((ComRemulasceLametroappJava_coreDynamic_dataTypesArrival *) nil_chk(update)) getDirection])) isEqual:destination_] && [((ComRemulasceLametroappJava_coreBasic_typesRoute *) nil_chk([update getRoute])) isEqual:route_] && [self stopBasicallyMatchesWithComRemulasceLametroappJava_coreBasic_typesStop:[update getStop] withComRemulasceLametroappJava_coreBasic_typesStop:stop_]) {
      ...
      for (ComRemulasceLametroappJava_coreDynamic_dataTypesArrival * __strong arrival in nil_chk(arrivals_)) {
        if ([((ComRemulasceLametroappJava_coreDynamic_dataTypesArrival *) nil_chk(arrival)) getVehicleNum] != nil && [((ComRemulasceLametroappJava_coreBasic_typesVehicle *) nil_chk([arrival getVehicleNum])) isEqual:[update getVehicleNum]]) {
          a = arrival;
          break;
        }
      }
      if (a != nil && [update getEstimatedArrivalSeconds] <= -30) {
  ...
  for (ComRemulasceLametroappJava_coreDynamic_dataTypesArrival * __strong arrival in nil_chk(arrivals_)) {
    if ([((ComRemulasceLametroappJava_coreDynamic_dataTypesArrival *) nil_chk(arrival)) getEstimatedArrivalSeconds] <= -30) {
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "stopBasicallyMatchesWithComRemulasceLametroappJava_coreBasic_typesStop:withComRemulasceLametroappJava_coreBasic_typesStop:", "stopBasicallyMatches", "Z", 0x1, NULL },
  ...
  static const J2ObjcClassInfo _ComRemulasceLametroappJava_coreDynamic_dataTypesStopRouteDestinationArrival = { 2, "StopRouteDestinationArrival", "com.remulasce.lametroapp.java_core.dynamic_data.types", NULL, 0x1, 12, methods, 10, fields, 0, NULL, 0, NULL};
