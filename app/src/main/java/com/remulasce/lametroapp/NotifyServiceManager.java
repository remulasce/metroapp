 ...
 *
 * <p>Handles starting the NotifyService You'd expect it to do some actual managing, given its name
 * But actually it just has a helper fxn for now. It's better than using MainActivity to do the same
 * thing, I guess.
 *
 * <p>But man, static is like as bad as global.
 */
public class NotifyServiceManager {
  public static void SetNotifyService(
      Stop stop,
      Route route,
