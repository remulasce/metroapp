 ...
 *
 * <p>This handles the omni textbar, add-request button, and clear button. It just pushes new
 * servicerequests to the service request list fragmentt.
 *
 * <p>That means this handles the autocomplete stuff too.
 */
public class OmniBarInputHandler {
  ...
  public OmniBarInputHandler(
      ProgressAutoCompleteTextView textView,
      Button clearButton,
  ...
  private final AdapterView.OnItemClickListener autocompleteSelectedListener =
  ...
  private final TextView.OnEditorActionListener omniDoneListener =
  ...
  private final View.OnClickListener clearButtonListener =
