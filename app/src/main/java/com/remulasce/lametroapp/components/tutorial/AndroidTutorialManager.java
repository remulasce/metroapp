 ...
 *
 * <p>does actual tutorial display on Android
 *
 * <p>Uses Settings saver thing to remember if the user has ever done specific actions before.
 */
public class AndroidTutorialManager extends TutorialManager {
  ...
  public void tripDismissed() {
    ...
    if (!userKnows(TUTORIAL_USER_KNOWS_UNDO_DISMISS)
        && System.currentTimeMillis() > lastDismissalPlay + 30000) {
