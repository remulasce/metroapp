 ...
 *
 * It makes a list of AutoCompleteEntries for the input bar.
 * Each entry has its priority and action set, but the list doesn't have to be listed yet.
 * The UI element can deal with that.
 *
 */
