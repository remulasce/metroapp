 ...
 *
 * <p>We display 'how to' messages to teach new users how to do things. They're kind of annoying.
 *
 * <p>So this thing is supposed to figure out whether a tutorial is actually needed.
 *
 * <p>Also this helps platform-abstract the tutorials. Even though it's totally not actually going
 * to java_core.
 *
 * <p>Singleton OK. Who cares about tutorial side effects? Nobody. Except for the tutorial itself.
 * The actual UI bit is platform-dependent.
 *
 * <p>So we fall into the singleton-does-nothing-unless-platform-does-something pattern. Catchy
 * name, huh?
 *
 * <p>(extend TutorialManager with platform-specific features. Then set the static tutorialmanager
