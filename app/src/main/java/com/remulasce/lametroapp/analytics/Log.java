 ...
 *
 * Quick abstraction of the Android builtin logging.
 * Default does nothing so you don't have to worry about it.
 *
 * Subclass Log and set the actual logger someplace to get real logs.
 */
public class Log {
