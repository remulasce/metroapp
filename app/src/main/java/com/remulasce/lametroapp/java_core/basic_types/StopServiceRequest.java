 ...
 *
 * <p>It's a service request added to show what vehicles are arriving.
 */
public class StopServiceRequest extends ServiceRequest {
  ...
  public Collection<Trip> getTrips() {
    ...
    for (Prediction p : this.predictions) {
      if (p instanceof StopRouteDestinationPrediction) {
        for (StopRouteDestinationArrival srda :
            ((StopRouteDestinationPrediction) p).getArrivals()) {
  ...
  private void makePredictions() {
    ...
    if (predictions.isEmpty()) {
      for (Stop s : stops) {
        StopRouteDestinationPrediction stopRouteDestinationPrediction =
            new StopRouteDestinationPrediction(s, null);
