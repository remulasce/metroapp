 ...
 *
 * <p>One Agency per seperate network-referenced transit provider. (this.raw) eg. lametro,
 * lametro-rail, bart, sf-muni
 *
 * <p>We support all Nextrip agencies by nextrip agency, as well as hardcoded BART gtfs data.
 *
 * <p>LaMetroUtils will figure out how to get a list of arrivals for you given your agency. So you
 * shouldn't have to deal with it here.
 *
 * <p>The agency boundary is now used for automatic region-switching. Display name is supposed to be
 * more publicly-showable. Don't assume it's short.
 */
public class Agency implements Serializable {
  ...
  public boolean isValid() {
    ...
    if (isBoundsBad()) {
      Log.w("Agency", "Agency is missing its bounds.");
    }
   ...
   *
   * <p>It's basically a developer-level hack.
   *
   * <p>Warning: This is not the same as .equals(), which requires a precise agency string match.
