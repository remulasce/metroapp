...
/** Hardcoded VTA colors Basically just the 2 rapids. */
public class HardcodedVTAColors implements RouteColorer {
  ...
  public RouteColor getColor(Route r) {
    ...
    if (r.getAgency().matches("VTA")) {
      if (raw.startsWith("522")) {
        return new RouteColor("#000000");
      }
      if (raw.startsWith("523")) {
        return new RouteColor("#000000");
      }
      if (raw.startsWith("900")) {
        return new RouteColor("#E4691C");
      }
      ...
      if (raw.startsWith("902")) {
        return new RouteColor("#99CC66");
      }
    }
