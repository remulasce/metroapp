...
/**
 * A {@link android.view.View.OnTouchListener} that makes any {@link View} dismissable when the user
 ...
 * (i.e. you're using {@link
 * android.widget.ListView#setOnItemClickListener(android.widget.AdapterView.OnItemClickListener)}
 * or an equivalent listener on {@link android.app.ListActivity} or {@link
 * android.app.ListFragment}, use {@link SwipeDismissListViewTouchListener} instead.</em>
 *
 * <p>Example usage:
 *
 * <pre>
...
public class SwipeDismissTouchListener implements View.OnTouchListener {
  ...
  public SwipeDismissTouchListener(View view, Object token, OnDismissCallback callback) {
    ...
    mAnimationTime =
        view.getContext().getResources().getInteger(android.R.integer.config_shortAnimTime) / 10;
    mView = view;
    mToken = token;
    mCallback = callback;
  }
